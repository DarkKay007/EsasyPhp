<?php
// abre permisos de cors para que se hagan consultas
...
// Definir rutas api
$rutas = [
    // primero la ruta // luego aparece la clase (inicioController) @ y el método "index"
    ...
    '/quince' => 'QuinceControlador@index',
    '/diepepito' => 'QuinceControlador@pepito',
    '/pokemons' => 'ModifyQueriesController@index',
    '/pokemon' => 'ModifyQueriesController@only',
    
];

$actualfolder = 'easyapiphp';
